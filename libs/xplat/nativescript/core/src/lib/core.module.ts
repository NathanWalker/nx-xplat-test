...
import { fontAwesomeIcons } from '@freshnx12/xplat/nativescript/utils';
...
export class Freshnx12CoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: Freshnx12CoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'Freshnx12CoreModule');
  }
}
